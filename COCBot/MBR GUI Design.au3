...
Func CreateMainGUIControls($bGuiModeUpdate = False)
	...
	If Not $bGuiModeUpdate Then
		...
		Local $g_hLblModEloy = GUICtrlCreateLabel("MODIFIED BY ELOY", $_GUI_MAIN_WIDTH - 121, $_GUI_MAIN_TOP + 91, 99, 12, $SS_RIGHT)
		GUICtrlSetFont(-1, 8.5, $FW_BOLD)
		GUICtrlSetColor(-1, 0x253D4D)
