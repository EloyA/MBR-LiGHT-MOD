...
Func chkDropOrder()
	...
	Else
		...
		GUICtrlSetBkColor($g_hBtnCustomDropOrderDB, $COLOR_MONEYGREEN)
		GUICtrlSetBkColor($g_hBtnCustomDropOrderAB, $COLOR_MONEYGREEN)
		GUICtrlSetBkColor($g_hBtnCustomDropOrderDB1, $COLOR_MONEYGREEN)
