...
Func CreateVillageMisc()
	...
	$g_hGUI_MISC_TAB_ITEM4 = GUICtrlCreateTabItem(GetTranslatedFileIni("MBR Main GUI", "MISC_TAB_ITEM4", "S•XP"))
		TabSuperXPGUI()
	$g_hGUI_MISC_TAB_ITEM5 = GUICtrlCreateTabItem(GetTranslatedFileIni("MBR Main GUI", "MISC_TAB_ITEM5", "Humanoid"))
		TabHumanizationGUI()
...
Func CreateMiscBuilderBaseSubTab()
	Local $x = 15, $y = 45
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "Group_05", "Builders Base Stats"), $x - 10, $y - 20, $g_iSizeWGrpTab3, 50 + 72)
		...
		$g_hTxtBB_DropTrophies = GUICtrlCreateInput("0", $x + 272, $y + 49, 32, 18, BitOR($SS_RIGHT, $ES_NUMBER))
	...
	Local $x = 15, $y = 190 + 64
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "Group_06", "Suggested Upgrades"), $x - 10, $y - 20, $g_iSizeWGrpTab3, 115)
...
#include "MBR GUI Design Child Bot - SuperXP.au3"
