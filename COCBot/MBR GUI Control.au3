...
#include "GUI\MBR GUI Control Eloy.au3"
...
Func BotClose($SaveConfig = Default, $bExit = True)
	...
	SetLog(" ")
	Sleep(250)
	SetLog(" •  " & "POWERED BY LiGHT MOD. " & $g_sModVersion, $COLOR_SUCCESS, "Candara", 9)
	Sleep(500)
	SetLog(" •  " & "THANKS FOR USING THIS MOD.", $COLOR_SUCCESS, "Candara", 9)
	Sleep(1000)
...
Func Bind_ImageList($nCtrl, ByRef $hImageList)
	...
	Switch $nCtrl
		...
		Case $g_hGUI_MISC_TAB
			Local $aIconIndex = [$eIcnTH1, $eIcnBuilderHall, $eIcnStrongMan, $eIcnSuperXP, $eIcnHumanoid]
